...
OpenRouter gives you access to hundreds of models (GPT-4o, Claude, Llama, Mixtral, and more) through a single API key.
...
- **Model**: Choose a model (e.g., `moonshotai/kimi-k2.5`, `openai/gpt-4o`, `anthropic/claude-sonnet-4`)
...
| `openai/gpt-4o` | OpenRouter | High quality reasoning |
