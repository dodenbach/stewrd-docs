...
Sessions are available on the **Scale plan** and above.
...
```json
{
  ...
  "files": [],
  "usage": { "requests_used": 12, "requests_limit": 50000, "tokens_used": 1847 },
...
| Plan requirement | Scale or Custom |
...
Sessions are only available on the **Scale plan** ($99/month) and above. Attempting to create a session with a Free, Dev, or Pro plan API key returns:
...
Upgrade at [stewrd.dev/pricing](https://stewrd.dev/pricing).
